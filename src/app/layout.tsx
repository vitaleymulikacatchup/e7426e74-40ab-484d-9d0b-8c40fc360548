...
export const metadata: Metadata = {
  title: "Sweet Delights Bakery - Fresh Artisan Baked Goods",
  description: "Premium bakery specializing in custom wedding cakes, artisan breads, and French pastries. Fresh daily baking with traditional techniques since 2015.",
  keywords: "bakery, wedding cakes, artisan bread, pastries, custom cakes, fresh baked goods",
  metadataBase: new URL("https://sweetdelightsbakery.com"),
  alternates: {
    canonical: "https://sweetdelightsbakery.com"
  },
  openGraph: {
    title: "Sweet Delights Bakery - Fresh Artisan Baked Goods",
    description: "Premium bakery specializing in custom wedding cakes, artisan breads, and French pastries",
    siteName: "Sweet Delights Bakery",
    images: [{
      url: "https://images.pexels.com/photos/4048668/pexels-photo-4048668.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "Sweet Delights Bakery - Fresh Artisan Baked Goods",
    description: "Premium bakery specializing in custom wedding cakes, artisan breads, and French pastries",
    images: ["https://images.pexels.com/photos/4048668/pexels-photo-4048668.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
